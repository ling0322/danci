...
public class FragmentAdapter1 extends FragmentPagerAdapter {
    ...
    public CustomFragment getItem(int item) {
        ...
        case 0:
            if (fragment[0] == null)
        	fragment[0] = (CustomFragment) DictionaryFragment.instantiate(Config.mainInstance, "org.ling0322.danci.DictionaryFragment");
            return fragment[0];
        case 1:
            if (fragment[1] == null)
        	fragment[1] = (CustomFragment) ReciteFragment.instantiate(Config.mainInstance, "org.ling0322.danci.ReciteFragment");
            return fragment[1];
        case 2:
            if (fragment[2] == null)
        	fragment[2] = (CustomFragment) ReviewListFragment.instantiate(Config.mainInstance, "org.ling0322.danci.ReviewListFragment");
            return fragment[2];
        }
        return null;
    }
